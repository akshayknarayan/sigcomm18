...
\begin{figure}[t]
\centering
    \includegraphics[width=\columnwidth]{ccp/img/ccp_design_sigcomm}
...
\begin{figure}[t]
\centering
    \includegraphics[width=\columnwidth]{ccp/img/bbr}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{ccp/img/ss-evo}
